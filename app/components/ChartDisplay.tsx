...
export default function ChartDisplay() {
  return (
    <motion.section
      ...
      className="group relative flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border border-border/70 bg-card/85 p-5 shadow-lg shadow-black/10 backdrop-blur-sm transition-shadow duration-300 hover:border-primary/30 hover:shadow-[0_24px_60px_rgba(0,0,0,0.22)]"
    >
      <span
        aria-hidden="true"
      ...
      <section className="relative z-10 mt-4 h-[300px] md:h-auto md:flex-1">
